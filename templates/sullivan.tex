...
\rightheadercontent{\includegraphics[width=3cm]{images/creodocs_logo.pdf}} % The content in the right header, you may want to add your own company logo or use your company/department name or leave this command empty for no right header content
...
\begin{fullwidth} % Use the whole page width
	...
	\hfill\includegraphics[width=5cm]{images/creodocs_logo.pdf} % Company logo
...
$body$\sidenote{This is a sidenote. This template features a large margin specifically so you can put notes, figures, tables and other things into it as additional material to the main content in the text block.}
